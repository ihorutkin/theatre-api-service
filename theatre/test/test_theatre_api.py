...
def sample_plays_session(**params):
...
class AuthenticatedplayApiTests(TestCase):
    ...
    def test_filter_plays_by_genres(self):
        ...
        play1 = sample_plays(title="play 1")
        play2 = sample_plays(title="play 2")

        play1.genres.add(genre1)
        play2.genres.add(genre2)

        play3 = sample_plays(title="play without genres")
    ...
    def test_filter_plays_by_actors(self):
        ...
        play3 = sample_plays(title="play without actors")
    ...
    def test_filter_plays_by_title(self):
        play1 = sample_plays(title="Play")
        play2 = sample_plays(title="Another play")
        play3 = sample_plays(title="No match")
...
class PlayImageUploadTests(TestCase):
    def setUp(self):
        ...
        self.client.force_authenticate(self.user)
        self.play = sample_plays()
        self.performance = sample_plays_session(play=self.play)
